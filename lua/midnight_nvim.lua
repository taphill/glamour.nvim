...
-- Completion Menu
Group.new('Pmenu', c.fg1, c.black, none)             -- Popup menu: normal item
...
-- TypeScript
Group.new('typescriptAliasDeclaration', c.yellow, c.none, none)
Group.new('typescriptAliasKeyword', c.red, c.none, italic)
...
Group.new('typescriptClassKeyword', c.red, c.none, italic)
Group.new('typescriptClassName', c.yellow, c.none, none)
Group.new('typescriptConditional', c.purple, c.none, none)
Group.new('typescriptCryptoGlobal', c.yellow, c.none, none)
...
Group.new('typescriptExceptions', c.purple, c.none, none)
Group.new('typescriptExport', c.red, c.none, none)
Group.new('typescriptFileReaderProp', c.fg1, c.none, none)
Group.new('typescriptForOperator', c.purple, c.none, none)
Group.new('typescriptFuncKeyword', c.red, c.none, italic)
Group.new('typescriptFuncTypeArrow', c.fg1, c.none, none)
Group.new('typescriptGlobal', c.yellow, c.none, none)
Group.new('typescriptIdentifier', c.purple, c.none, none)
Group.new('typescriptIdentifierName', c.fg1, c.none, none)
Group.new('typescriptImport', c.aqua, c.none, none)
Group.new('typescriptImportType', c.aqua, c.none, none)
Group.new('typescriptInterfaceKeyword', c.red, c.none, italic)
Group.new('typescriptMember', c.purple, c.none, none)
Group.new('typescriptMemberOptionality', c.aqua, c.none, none)
Group.new('typescriptMethodAccessor', c.purple, c.none, italic)
Group.new('typescriptModule', c.aqua, c.none, none)
Group.new('typescriptNull', c.yellow, c.none, none)
Group.new('typescriptObjectColon', c.aqua, c.none, none)
Group.new('typescriptParens', c.aqua, c.none, none)
Group.new('typescriptPredefinedType', c.aqua, c.none, none)
Group.new('typescriptProp', c.fg1, c.none, none)
Group.new('typescriptRepeat', c.purple, c.none, none)
Group.new('typescriptResponseProp', c.fg1, c.none, none)
Group.new('typescriptStatementKeyword', c.red, c.none, none)
Group.new('typescriptTemplateSB', c.aqua, c.none, none)
Group.new('typescriptTestGlobal', c.blue, c.none, none)
Group.new('typescriptTry', c.purple, c.none, none)
Group.new('typescriptTypeAnnotation', c.aqua, c.none, none)
...
Group.new('typescriptTypeReference', c.aqua, c.none, none)
